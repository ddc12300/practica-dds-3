...
El impacto de estos cambios en el rendimiento del modelo ha sido notable, con un aumento en el AUC de 0.9978 a 0.9996. Este incremento no solo demuestra la efectividad de las modificaciones realizadas sino que también resalta la calidad y la precisión de nuestro modelo en la detección de ataques a partir de los logs de un firewall.
```
